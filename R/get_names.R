get_names <- function(row) {
  def <- list(
    ...
    "H" = c("<ENUM.SRC.ID>","<SYMBOL.TICKER>","<CURRENCY.STRING>","<ISIN>",
            "<SEDOL>","<CUSIP>","<DISPLAY.PRECISION>","<TRADE.OPEN>",
    ...
    "T" = c("<TAS.SEQ>","<RNR.END.EXCH.SEQ>","<ACTIVITY.DATETIME>",
    ...
    "B" = c("<TAS.SEQ>","<RNR.END.EXCH.SEQ>","<ACTIVITY.DATETIME>",
            "<BID.PRICE>","<BID.SIZE>","<BID.PART.CODE>","<ASK.PRICE>",
            "<ASK.SIZE>","<ASK.PART.CODE>","<EXCH.MESSAGE.TIMESTAMP>"),
    "S" = c("<TAS.SEQ>","<ACTIVITY.DATETIME>","<TRADABLE.STATUS>",
